...
export const MortgageCalculator: React.FC<MortgageCalculatorProps> = ({
  ...
  const calculatePayment = (): CalculationResults => {
    ...
    const monthlyPayment = monthlyPrincipalInterest + (includeExtras ? monthlyTaxesInsurance : 0);

    // Total calculations
    const totalPrincipalInterest = monthlyPrincipalInterest * numberOfPayments;
    const totalInterest = totalPrincipalInterest - principal;
    const totalExtras = includeExtras ? monthlyTaxesInsurance * numberOfPayments : 0;
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            ...
            <p className="text-sm text-yellow-700 mt-1">
              This calculator provides estimates based on the information provided. Actual mortgage payments may vary based on lender requirements, credit score, down payment, and other factors. Always consult with a qualified mortgage professional for accurate quotes.
            </p>
          </div>
        </div>
      </div>
